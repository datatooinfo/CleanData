The run_analysis.R script merges two input data sets . Once merged, the mean and standard deviation are extracted for variables containing the string mean or std. 
